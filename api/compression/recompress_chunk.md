...
The procedure is now a wrapper which calls [`compress_chunk`](/api/:currentVersion:/compression/compress_chunk/) 
instead of it. 
...
chunk for the first time, use [`compress_chunk`](/api/:currentVersion:/compression/compress_chunk/).
</Highlight>
