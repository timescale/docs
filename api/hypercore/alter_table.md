...
ALTER TABLE <table_name> SET (timescaledb.enable_columnstore,
   ...
   ALTER <COLUMN> SET { NOT NULL | UNIQUE}
);
```
...
| `timescaledb.enable_sparse_index_bloom`    |BOOLEAN| `true`                                               | ✖ | A [bloom filter][bloom-filters] is an additional sparse index, like min-max, that optimizes queries for faster retrieval. For data added to columnstore using TimescaleDB 2.19.3 and lower, you need to recompress data in the columnstore to enable bloom filters.                                                                                                                                                                                                                                                               |
...
| `ALTER`                                    |TEXT| | ✖| Set a specific column in the columnstore to be NOT NULL or UNIQUE.                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
