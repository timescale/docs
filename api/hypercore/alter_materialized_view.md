...
|`SET ACCESS METHOD`|TEXT| DEFAULT ([heap][default_table_access_method])| ✖| To enable indexing on the $COLUMNSTORE, set to `hypercore` after you [create a continuous aggregate][create-cagg].    <EarlyAccess />                                                                                                                                                                                                                                                                                                                                                                                       |
