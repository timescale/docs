---
title: Compression
excerpt: Timescale Cloud API reference for compressing your data. Include SQL functions for compressing and decompressing chunks, managing compression policies, and getting compression stats
