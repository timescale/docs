...
| `refresh_newest_first` | BOOLEAN | This control the order of incremental refresh. `TRUE` means from the newest data to the oldest and `FALSE` from the oldest to the newest. The default is `TRUE`. | |
