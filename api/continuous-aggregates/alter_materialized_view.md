...
| `timescaledb.enable_cagg_window_functions` |BOOLEAN|EXPERIMENTAL: enable window functions on continuous aggregates. Support is experimental, as there is a risk of data inconsistency if the user is not careful. 
 For example, in backfill scenarios, buckets could be missed. |
|
## Sample usage
