...
dimension. To create a new hypertable, best practice is to call <a href="https://www.tigerdata.com/docs/api/:currentVersion:/hypertable/create_table/">CREATE TABLE</a>.
