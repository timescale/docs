...
dimension. To create a new hypertable, best practice is to call <a href="https://www.tigerdata.com/docs/api/latest/hypertable/create_table/">CREATE TABLE</a>.
