...
1. **Select your $SERVICE_SHORT in [$CONSOLE_SHORT][console], then click `Actions` > `Import data` > `Upload your files` > `Upload CSV file`**
   ...
   ![Import from CSV into Tiger][import-from-csv-into-tiger]

1. **Click to browse, or drag the file to import**
1. **Configure the import**

   ![Configure the CSV import in Tiger][configure-the-csv-import-in-tiger]
...
1. **Select your $SERVICE_SHORT in [$CONSOLE_SHORT][console], then click `Actions` > `Import data` > `Upload your files` > `Upload Parquet file`**
   ...
   ![Import from Parquet into Tiger][import-from-parquet-into-tiger]

1. **Click to browse, or drag the file to import**
1. **Configure the import**

   ![Configure the Parquet import in Tiger][configure-the-parquet-import-in-tiger]
...
1. **Select your $SERVICE_SHORT in [$CONSOLE_SHORT][console], then click `Actions` > `Import data` > `Upload your files` > `Upload Text file`**

   ![Import from a text file into Tiger][import-from-a-text-file-into-tiger]
...
1. **Configure the import**
   ...
   ![Configure the text file import in Tiger][configure-the-text-file-import-in-tiger]
...
1. **Select your $SERVICE_SHORT in [$CONSOLE_SHORT][console], then click `Actions` > `Import data` > `Explore import options` > `Import from S3`**

1. **Select your file in the S3 bucket**

   ![Import CSV from S3 in Tiger][import-csv-from-s3-in-tiger]
...
1. **Configure the import**
   ...
   ![Configure CSV import from S3 in Tiger][configure-csv-import-from-s3-in-tiger]
...
1. **Select your $SERVICE_SHORT in [$CONSOLE_SHORT][console], then click `Actions` > `Import from S3`**

1. **Select your file in the S3 bucket**

   ![Import Parquet from S3 in Tiger][import-parquet-from-s3-in-tiger]
