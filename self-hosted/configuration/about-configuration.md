...
By default, TimescaleDB uses the default $PG server configuration
...
Some of these settings are $PG settings, and some are TimescaleDB
...
$PG uses worker pools to provide workers for live queries and background
...
larger queries, $PG automatically uses parallel workers if they are
...
$PG workers. It should be at least the sum of
