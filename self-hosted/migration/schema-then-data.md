...
excerpt: Migrate your data and schema to self-hosted TimescaleDB. This method copies each table or chunk separately, which allows you to restart midway if one copy operation fails
