...
excerpt: Last observation carried forward (LOCF) takes the last known value and uses it as a replacement for the missing data, to make sure your queries run smoothly. Learn more about LOCF in Timescale Cloud
