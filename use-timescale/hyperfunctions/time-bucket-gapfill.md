...
excerpt: If you have missing data, sorting it into time buckets might be problematic. To solve this, you can use the gapfilling function in Timescale Cloud to create rows and then add data using interpolation or LOCF
