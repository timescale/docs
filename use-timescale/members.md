...
When you are asked to join a project, the $CONSOLE sends you an invitation email. Follow the
...
- **[Enterprise plan][pricing-plans] and SAML user**:
  ...
  2. Click `Notifications`, then accept the invitation. 
     ...
     included in more than one project, you can easily [change projects][change-project].
...
1.  In the [$CONSOLE][cloud-login], click `Invite users`.
