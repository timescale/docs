...
When you issue a query that uses $SKIPSCAN_SHORT, the `EXPLAIN` output includes a new
...
- Multi-column $SKIPSCAN_SHORT is supported for queries that do not produce NULL distinct values.
