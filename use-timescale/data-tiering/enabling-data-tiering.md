...
1. **Select the IOPS value in the `I/O boost` dropdown**
   ...
   ![Default standard storage in Tiger Cloud](https://assets.timescale.com/docs/images/high-performance-storage-timescale.png)
...
1. **Select `Enhanced` in the `Storage type` dropdown**
    ...
    ![Enhanced storage in Tiger Cloud](https://assets.timescale.com/docs/images/enable-enhanced-storage-timescale.png)
...
1. **Select the IOPS value in the `I/O boost` dropdown**
   ...
   ![I/O boost in Tiger Cloud](https://assets.timescale.com/docs/images/set-io-boost-timescale.png)
