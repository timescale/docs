---
title: Indexing data
excerpt: Adding an index can significantly speed up queries on your service. Learn what database indexes are created by default in Timescale Cloud and what best practices are for creating them manually
