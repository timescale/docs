...
<Deprecated2180 /> Superseded by <a href="https://www.tigerdata.com/docs/use-timescale/:currentVersion:/hypercore/">hypercore</a>. However, compression APIs are still supported, you do not need to migrate to the hypercore APIs.
