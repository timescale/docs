...
<Deprecated2180 /> This function has been replaced by [`convert_to_rowstore`](https://docs.timescale.com/api/latest/hypercore/convert_to_rowstore/).
...
database. But you should always leave some additional storage
