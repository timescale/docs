...
To have $CLOUD_LONG as a part of your Azure infrastructure, you create a $ACCOUNT_LONG through Azure Marketplace. In this
...
1. **Review product details and click `Subscribe`**

1. **Configure your subscription and click `Review & subscribe`**

1. **Review the legal terms and click `Subscribe`**
...
[azure-paygo]: https://aws.amazon.com/marketplace/pp/prodview-iestawpo5ihca?applicationId=AWSMPContessa&ref_=beagle&sr=0-1
