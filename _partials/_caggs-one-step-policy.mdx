...
<highlight type="note">
  The policies changed using this API apply to the continuous aggregate, not to
  the original hypertable. For example, if you use this API to set a retention
  policy of 20 days, chunks older than 20 days are dropped from the continuous
  aggregate. The retention policy of the original hypertable remains unchanged.
</highlight>
