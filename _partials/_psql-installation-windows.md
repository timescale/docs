...
$PG, and this is the most effective way to install the tool. These
instructions use the interactive installer provided by $PG and
EnterpriseDB.
...
1.  Download and run the $PG installer from
