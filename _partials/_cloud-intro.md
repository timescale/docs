...
and [insights][insights],&nbsp;[streamlined maintenance][maintain-upgrade],&nbsp;and much more. Free $SERVICE_LONGs include a basic scope of features  required to start with $CLOUD_LONG. $CLOUD_LONG continuously monitors your $SERVICE_SHORTs and prevents common $PG out-of-memory crashes.
