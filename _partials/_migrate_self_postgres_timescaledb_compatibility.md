...
We recommend not using $TIMESCALE_DB with PostgreSQL 17.1, 16.5, 15.9, 14.14, 13.17, 12.21.  
...
Users of [$SERVICE_LONG](https://console.cloud.timescale.com/) and platform packages for Linux, Windows, MacOS,
