...
1. **Connect the source database and the target $SERVICE_SHORT**
   ...
   ![Postgres connector wizard](https://assets.timescale.com/docs/images/tiger-on-azure/pg-connector-wizard-tiger-cloud.png)
...
1. **Monitor synchronization**
   ...
   ![Tiger Cloud connectors overview](https://assets.timescale.com/docs/images/tiger-on-azure/tiger-cloud-connector-overview.png)
...
1. **Manage the connector**
   ...
   ![Edit a Postgres connector](https://assets.timescale.com/docs/images/tiger-on-azure/edit-pg-connector.png)
