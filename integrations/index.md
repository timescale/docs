---
title: Integrations
excerpt: Built on Postgre, Tiger Cloud can integrate with the same array of third-party solutions. See integration procedures for the most popular and requested third-party services
...
|                <img isIcon src='https://assets.timescale.com/docs/icons/postgresql-logo.png' alt='postgresql-logo' />[PostgreSQL][postgresql]                 | Access and query data from external sources as if they were regular $PG tables.                                                           |
