...
1. **Retreive your project ID**:
   ...
   ![Retrive the project id in $CONSOLE](https://assets.timescale.com/docs/images/tiger-on-azure/tiger-cloud-console-project-id.png)

1. **Retrieve your service ID**:

   Click the dots next to the service, then click `Copy` next to the service ID.
   ![Retrive the service id in $CONSOLE](https://assets.timescale.com/docs/images/tiger-on-azure/tiger-cloud-console-service-id.png)
