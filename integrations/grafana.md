...
1. **Group your visualizations and order the results by [time buckets][time-buckets]** 
    ...
    ![Timescale Cloud service and Grafana query results](https://assets.timescale.com/docs/images/grafana_query_results.png)
   ...
   ![Timescale Cloud service and Grafana query results in time buckets](https://assets.timescale.com/docs/images/grafana_query_results_5m.png)
...
1.  **Customize the Geomap settings** 
    ...
    ![Timescale Cloud service and Grafana integration](https://assets.timescale.com/docs/images/timescale-grafana-integration.png)
