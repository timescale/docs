...
class TigerDataDocumentationGenerator:
    ...
    def _load_comprehensive_variables(self) -> Dict[str, str]:
        ...
        return {
            ...
            '$WEBSITE_DOCS': 'tigerdata.com/docs',
    ...
    def _parse_page_structure(self, js_array: str, section_dir: str) -> List[Tuple[str, str]]:
        ...
        for obj in objects:
            ...
            # Add the parent page
            url = f"https://www.tigerdata.com/docs/{section_dir}/{href}/"
            ...
            if children_match:
                ...
                for child_obj in child_objects:
                    ...
                    if child_href_match:
                        ...
                        child_url = f"https://www.tigerdata.com/docs/{section_dir}/{child_href}/"
    ...
    def normalize_url(self, url: str) -> str:
        ...
        if url.startswith('/') and not url.startswith('//'):
            url = f'https://www.tigerdata.com/docs{url}'
    ...
    def generate_fallback_documentation(self) -> List[str]:
        ...
        for md_file in self.docs_dir.rglob("*.md"):
            ...
            url = f"https://www.tigerdata.com/docs/{url_path}/"
    ...
    def should_exclude_file(self, file_path: Path) -> bool:
        ...
        exclude_patterns = [
            'node_modules',
            'deprecated',
            '/old',      # Matches /old, /OLD, /Old directories
            'old_',      # Matches old_ prefixes in filenames
            '_old',      # Matches _old suffixes in filenames
            'archive',
            'draft',
            'template',
            '.template',
        ...
        if any(pattern.lower() in path_str for pattern in exclude_patterns):
            return True

        # Additional check: exclude files that start with "OLD" (case-insensitive)
