...
Managed Service for TimescaleDB provides managed TimescaleDB services
...
Some important Managed Service for TimescaleDB terms:
*   **Account:** Your Managed Service for TimescaleDB account. You can register for an account on the
...
## Hosted TimescaleDB
Built and operated by the team behind TimescaleDB, Managed Service for TimescaleDB provides a
