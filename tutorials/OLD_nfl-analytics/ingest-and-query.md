...
These queries are examples of hyperfunctions. To access hyperfunctions, you need to have installed the  [Timescale toolkit](https://docs.tigerdata.com/use-timescale/latest/install-timescaledb-toolkit/) before you begin.
</Highlight>
