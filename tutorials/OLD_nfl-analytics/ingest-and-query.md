...
These queries are examples of hyperfunctions. To access hyperfunctions, you need to have installed the  [$TOOLKIT_LONG](https://www.tigerdata.com/docs/use-timescale/:currentVersion:/install-timescaledb-toolkit/) before you begin.
