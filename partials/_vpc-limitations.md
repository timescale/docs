...
* You **cannot attach** a $SERVICE_LONG to multiple Peering $VPCs at the same time.
  ...
  If you need another Peering $VPC, either contact [support@timescale.com](mailto:support@timescale.com) or change your $PRICING_PLAN in [$CONSOLE][console-login].
