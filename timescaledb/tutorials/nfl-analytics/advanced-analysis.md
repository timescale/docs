...
This query uses a percentile approximation [hyperfunction](https://docs.timescale.com/api/latest/hyperfunctions/percentile-approximation/percentile-approximation) 
