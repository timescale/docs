...
Each database instance in $COMPANY is called a $SERVICE_SHORT.

This section shows you how to:

1.  [Create and connect to a $SERVICE_LONG][services-create]
1.  [Run queries from $CONSOLE][run-queries-from-console]
