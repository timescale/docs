...
1. In the [$SERVICE_SHORT creation page][create-service], choose the PostgreSQL capability or add `Time-series and analytics` and `AI and Vector` capabilities. Click `Save and continue`.
...
If you choose to go directly to the service overview, [Connect to your $SERVICE_SHORT][connect-to-your-service] 
